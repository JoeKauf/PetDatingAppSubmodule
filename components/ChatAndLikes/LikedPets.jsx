...
const LikedPets = ({ navigation, setSelectedAnimal, petData, email }) => {
    let petCards = [];
    petData.forEach(pet => petCards.push(
        <TouchableOpacity
            ...
            <ImageBackground source={{ uri: pet.pictures[0] }} resizeMode="cover" style={styles.image} imageStyle={{ borderRadius: 8 }}>
                ...
                >
                    ...
                    <View style={styles.ChatHeartContainer}>
                        <Heart id={pet.id} petID={pet.petID} email={email} />
                        <ChatButton navigation={navigation} petData={pet} />
                    </View>
                </LinearGradient>
            </ImageBackground>
        </TouchableOpacity>
    ...
    return (
        <View syle={styles.promptContainer}>
            <Text style={styles.promptText}>Tap an animal to see more info</Text>
